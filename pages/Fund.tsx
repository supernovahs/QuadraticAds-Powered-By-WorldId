  ...
  return (
    <div>
      ...
      <div className="border-2 border-black m-2 p-2 ">
        ...
        // disabled= {!Proof || !Ad}
          onClick={(async()=>{
            console.log("Ad",Ad,"Merkle root",Proof?.merkle_root, "Nullifier hash",Proof?.nullifier_hash,"Proof 8",ethers.utils.defaultAbiCoder.decode(["uint256[8]"], Proof.proof)[0]);
            await contract.Fund(
              Ad,
              Ad,
              Proof.merkle_root,
              ...
              { gasLimit: 10000000,value:ethers.utils.parseEther("0.01").toString()}
              )
          })}
        >
          Fund
